    ...
    while (pelicula != "x" && pelicula != "X") {
        switch (pelicula) {
            ...
            case "5":
                ...
                break;
            default:
                pelicula = prompt(`No ingresó una opción válida. Por favor seleccione una película de la lista:
                1. Dragon Ball Super: Super Hero
                2. El Brindis
                3. El Joven Ahmed
                4. Perro Samurai
...
let combo = prompt(`Seleccione el combo que desea agregar o X para cancelar toda la operación
    1. Pop Corn grande + 2 gaseosas ($1200)
    2. Pop Corn mediano + 2 gaseosas ($1000)
    3. Pop Corn chico + 1 gaseosa ($800)
